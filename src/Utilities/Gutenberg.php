    ...
    public static function setupColorPallete()
    {
        $function = function() {
            add_theme_support('editor-color-palette', [
                ...
                [
                    'name' => __('secondary', 'cypher'),
                    'slug' => 'secondary',
                    'color' => CYPHER_COLOR_SECONDARY,
                ],
                [
                    'name' => __('black', 'cypher'),
                    'slug' => 'black',
                    'color' => CYPHER_COLOR_BLACK,
                ],
                [
                    'name' => __('black-bis', 'cypher'),
                    'slug' => 'black-bis',
                    'color' => CYPHER_COLOR_BLACK_BIS,
                ],
                [
                    'name' => __('black-ter', 'cypher'),
                    'slug' => 'black-ter',
                    'color' => CYPHER_COLOR_BLACK_TER,
                ],
                [
                    'name' => __('grey-darker', 'cypher'),
                    'slug' => 'grey-darker',
                    'color' => CYPHER_COLOR_GREY_DARKER,
                ],
                [
                    'name' => __('grey-dark', 'cypher'),
                    'slug' => 'grey-dark',
    ...
    public static function setupFontSizes()
    {
        $functions = function() {
            add_theme_support('editor-font-sizes', [
                [
                    'name' => __( 'small', 'cypher' ),
                    'shortName' =>  __( 'S', 'cypher' ),
                    'size' => CYPHER_SIZE_SMALL,
                    'slug' => 'small',
                ],
                [
                    'name' => __( 'normal', 'cypher' ),
                    'shortName' =>  __( 'N', 'cypher' ),
                    'size' => CYPHER_SIZE_NORMAL,
                    'slug' => 'normal',
                ],
                [
                    'name' => __( 'medium', 'cypher' ),
                    'shortName' =>  __( 'M', 'cypher' ),
                    'size' => CYPHER_SIZE_MEDIUM,
                    'slug' => 'medium',
                ],
                [
                    'name' => __( 'large', 'cypher' ),
                    'shortName' =>  __( 'L', 'cypher' ),
